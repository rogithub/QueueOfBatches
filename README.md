...
Here are the main components.
  ...
  - TaskRunner. It is an Fsharp wrapper around MailboxProcessor class that is the core part of the server. It takes tasks in the form of ITask interface and executes them in multithreaded batches. **Important:** Only one instance per ITaskProvider can run at a given time. You can run multiple instances as long as they have different sources.
